 ...
 */
public class CmsRandomUtil {
    private static final Random random = new Random();

    private CmsRandomUtil() {
//     random = new Random();
    }
    ...
    public static String[] random(final int length, final int num) {
        return new CmsRandomUtil().buildRandom(length, num);
    }
    ...
    public static String random(final int length) {
        return new CmsRandomUtil().buildRandom(length);
    }
    ...
    public static String randombunch(int length, int num) {
        ...
        for (int i = 0; i < num; i++) {
            str.append(CmsRandomUtil.random(length));
            if (i != num - 1)
                str.append("-");
        }
        return str.toString();
