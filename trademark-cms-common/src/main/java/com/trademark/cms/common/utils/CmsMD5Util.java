...
public class CmsMD5Util {
    ...
    public static void main(String[] args) {
        System.out.println(CmsMD5Util.md5password("123"));
        System.out.println(CmsMD5Util.MD5("123456"));
        System.out.println(CmsMD5Util.md5password(md5password(md5password("123"))));
        System.out.println(CmsMD5Util.JM(JM("123")));
    }
}
