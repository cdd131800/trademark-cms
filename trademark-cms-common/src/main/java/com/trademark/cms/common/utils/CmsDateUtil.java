...
public class CmsDateUtil {
    ...
    public static String getCurrentHour() {
        ...
        if (hour < 10) {
            return CmsDateUtil.getCurrentTime("yyyy-MM-dd HH:mm:ss") + " 0" + hour;
        }
        return CmsDateUtil.getDateByString() + " " + hour;
    }
    ...
    public static String getCurrentHourBefore() {
        ...
        if (hour > 0) {
            ...
            if (hour < 10) {
                return CmsDateUtil.getDateByString() + " 0" + hour;
            }
            return CmsDateUtil.getDateByString() + " " + hour;
        }
        //获取当前日期前一天
        return CmsDateUtil.getBeforeDay() + " " + 23;
    }
